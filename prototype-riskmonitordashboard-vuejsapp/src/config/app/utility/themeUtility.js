...
let { customGradient, customDashboardGradient } = customColors
let { defaultGradient, defaultDashboardGradient } = colors
let errorColor = ''
let primaryColor = ''
let secondaryColor = ''
let infoColor = ''
...
if (enableThemes === true) {
  ...
  dashboardGradient = customDashboardGradient
} else {
  ...
  dashboardGradient = defaultDashboardGradient
}
